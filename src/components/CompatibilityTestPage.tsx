...
export const CompatibilityTestPage = () => {
  ...
  return (
    <>
      <header className="compatibility-test-page-header">
      ...
      <section className="card-base compatibility-current-test">
      ...
      {/* Accessibility Test */}
      <section className="card-base compatibility-accessibility-test">
      ...
      {summary && (
        <section className="card-base compatibility-summary">
      ...
      <section className="card-base compatibility-instructions">
        <h2 className="compatibility-section-title">Testing Instructions</h2>
        <article className="compatibility-instruction">
      ...
      <section className="card-base compatibility-limitations">
        <h2 className="compatibility-section-title">Known Issues and Limitations</h2>

        <article className="compatibility-limitation">
      ...
      <section className="card-base compatibility-future-plan">
        <h2 className="compatibility-section-title">Future iOS Support Plan</h2>
          ...
          <article className="compatibility-future-features">
          ...
          <article className="compatibility-future-ui">
